...
backshore_mapping <- c(
  ...
  "8" = "Low bluffs with low ice-wedge degradation",
  "9" = "Medium bluffs with low ice-wedge degradation",
  "10" = "Slump toe bluffs",
)
...
data$Backshore_detail <- backshore_mapping[as.character(data$Backshore_detail)]
...
p <- ggplot(average_epr, aes(x = Average_EPR, y = reorder(Backshore_detail, -Average_EPR), fill = Backshore_detail)) +
